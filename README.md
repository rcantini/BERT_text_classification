...
### Toxicity detection
<img src="https://github.com/rcantini/BERT_text_classification/blob/main/toxic_comments/results/pred_tox.PNG" style="margin:auto; display: block; margin-left: auto; margin-right: auto; width: 90%; height: 90%"/>
